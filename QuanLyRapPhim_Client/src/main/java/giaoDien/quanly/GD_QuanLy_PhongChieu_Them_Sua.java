...
public class GD_QuanLy_PhongChieu_Them_Sua extends JFrame {
	...
	public static void main(String[] args) {
		...
		GD_QuanLy_PhongChieu_Them_Sua run = new GD_QuanLy_PhongChieu_Them_Sua();
		run.setVisible(true);
	}
	 ...
	 * Create the frame.
	 */
	public GD_QuanLy_PhongChieu_Them_Sua() {
		...
		JLabel lblThemSuaPC = new JLabel("Thêm/Sửa phòng chiếu");
