...
//		lbltennv.setText(UserInfo.getTenNhanVien());
		...
		btnVe.setIcon(new ImageIcon(GD_QuanLy.class.getResource("/imgs/tickets2.png")));
		...
		btnDoAn.setIcon(new ImageIcon(GD_QuanLy.class.getResource("/imgs/popcorn2.png")));
		...
		btnThongKeThucAn.setIcon(new ImageIcon(GD_QuanLy.class.getResource("/imgs/popcorn2.png")));
