...
public class GD_QuanLy_SuaDichVu extends JFrame {
	...
	public static void main(String[] args) {
		...
		GD_QuanLy_SuaDichVu run = new GD_QuanLy_SuaDichVu();
		run.setVisible(true);
	}
	...
	public GD_QuanLy_SuaDichVu() {
		...
		JLabel lblSuaDoAn = new JLabel("Sửa đồ ăn");
		lblSuaDoAn.setForeground(new Color(0, 66, 132));
		lblSuaDoAn.setFont(new Font("Tahoma", Font.BOLD, 22));
		lblSuaDoAn.setBounds(170, 53, 200, 44);
		contentPane.add(lblSuaDoAn);
