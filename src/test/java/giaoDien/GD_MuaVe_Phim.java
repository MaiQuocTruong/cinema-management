...
//	static String quanly;
	...
	public static void main(String[] args) {
		try {
			...
			java.util.logging.Logger.getLogger(GD_MuaVe_Phim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	...
	public GD_MuaVe_Phim() {
		...
		lblNvIcon.setIcon(new ImageIcon(GD_MuaVe_Phim.class.getResource("/imgs/avt.png"))); // Thay đổi đường dẫn ảnh của
																						// bạn
...
//		panelChonVe.setVisible(false); // ẩn panel
		...
		hoaDonButton.setIcon(new ImageIcon(GD_MuaVe_Phim.class.getResource("/imgs/bill.png")));
