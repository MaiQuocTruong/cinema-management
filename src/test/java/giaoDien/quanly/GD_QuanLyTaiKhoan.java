...
import giaoDien.nhanvien.GD_MuaVe_Phim;
...
public class GD_QuanLyTaiKhoan extends JFrame implements ActionListener {
	/**
	 * 
	 */
...
//	static String quanly;
	...
	public static void main(String[] args) {
		try {
			...
			java.util.logging.Logger.getLogger(GD_QuanLyTaiKhoan.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		GD_QuanLyTaiKhoan run = new GD_QuanLyTaiKhoan();
		run.setVisible(true);
	}
...
//		initComponents();
		...
		lblNvIcon.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/avt.png"))); // Thay đổi đường dẫn
																									// ảnh của
		// bạn
...
//		lbltennv.setText(UserInfo.getTenNhanVien());
		...
		muaVeButton.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/tickets1.png")));
...
//		panelChonVe.setVisible(false); // ẩn panel
		...
		btnPhim.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/film-reel.png")));
		...
		btnGhe.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/chair.png")));
		JButton btnThucAn = new JButton("Thức Ăn");
		btnThucAn.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnThucAn.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/popcorn2.png")));
		JButton btnSuatChieu = new JButton("Suất Chiếu");
		btnSuatChieu.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnSuatChieu.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/clapperboard2.png")));
		...
		hoaDonButton.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/bill.png")));
		...
		khachHangButton.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/bill.png")));
		...
		logoutButton.setIcon(new ImageIcon(GD_QuanLyTaiKhoan.class.getResource("/imgs/logout.png")));
